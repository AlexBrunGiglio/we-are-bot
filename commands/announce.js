  ...
  static action (message) {
    ...
    switch(args[0]){
      case 'an' :
        ...
        .setColor(0x72c8e2)
        .setDescription("Je viens vous apporter une superbe nouvelle ! \nComme vous le savez peut-être il y a sur le serveur un bot qui se nomme <@302050872383242240>. \n \nLe principe est de mettre tout les serveur le possédant sur un site internet. Cependant les serveurs qui utilise la commande '!d bump' sont mit en avant pour une durée de 2h.\n \nC'est pourquoi pour vous encourager à bumper nous avons créé un système de trophées ! \nTout les mois nous comptabiliserons vos bumps, ceux qui arriveront à bumper au moins 50 fois décrocheront le rôle <@&701195227393949747>  et devront remettre leurs titres en jeu le mois d'après !\n\nBon courage à tout le monde ! \n")
